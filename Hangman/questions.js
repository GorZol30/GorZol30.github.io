// Generált kérdések adatbázis - question.lst alapján
window.szolasok = [
  ...
  "OTT SZAKAD A KÖTÉL, AHOL A LEGVÉKONYABB.",
  ...
  "ELKAPTA A GÉPSZÍJ.",
  "MÁSSAL KAPARTATJA KI A GESZTENYÉT A PARÁZSBÓL.",
  ...
  "ÚGY HIÁNYZOTT, MINT ÜVEGES TÓTNAK A HANYATTESÉS.",
  ...
  "KÉT ÉLES TŐR NEM FÉR MEG EGY HÜVELYBEN.",
  "MEGY, MINT A KARIKACSAPÁS.",
  "NYÍLT KÁRTYÁKKAL JÁTSZIK.",
  "NEM ESZIK A KÁSÁT OLYAN FORRÓN, AHOGY FŐZIK.",
  ...
  "ELHÚZZA AZ ORRA ELŐTT A MÉZESMADZAGOT.",
  ...
  "FOGADATLAN PRÓKÁTORNAK EB A FIZETÉSE.",
  ...
  "SZAMÁRBŐGÉS NEM HALLATSZIK A MENNYBE.",
  ...
  "KISZABADÍTOTTA A PALACKBÓL A SZELLEMET.",
  "SZÉLMALOMHARCOT VÍV.",
